        ...
        <table class="table table-borderless table-sm">
          <tbody>
            <tr>
              ...
              <td class="border-top border-right border-bottom border-left fontSizeVal" width="300" align="center">{{ $member->memberid }}</td>
              ...
              <td class="border-top border-right border-bottom border-left">{{ $member->married ? 'YES' : 'NO' }}</td>
            </tr>
            <tr>
              <td class="fontSizelbl">Member Name</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->membername }}</td>
              <td class="fontSizelbl">Phone Office</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->phoneoffice }}</td>
            </tr>
            <tr>
              <td class="fontSizelbl">Father Name</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->memberfname }}</td>
              <td class="fontSizelbl">Phone Res. </td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->phoneresidence }}</td>
            </tr>
            <tr>
              <td class="fontSizelbl">Club</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">DHA J Club</td>
              <td class="fontSizelbl">Mobile No</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->mobileno }}</td>
            </tr>
            <tr>
              <td class="fontSizelbl">Member Type</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->type ? $member->type->des : '' }}</td>
              <td class="fontSizelbl">Fax</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->fax }}</td>
            </tr>
            <tr>
              <td class="fontSizelbl">CNIC</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->cnic }}</td>
              <td class="fontSizelbl">Email</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->email }}</td>
            </tr>
            <tr>
              <td class="fontSizelbl">Occupation</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->occupation ? $member->occupation->des : '' }}</td>
              ...
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->otherinfo }}</td>
            </tr>
            <tr>
              <td class="fontSizelbl">Department</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->department }}</td>
              <td class="fontSizelbl">Staus</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->status }}</td>
            </tr>
            <tr>
              <td class="fontSizelbl">Organisation</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->organisation }}</td>
              <td></td>
              <td class="fontSizelbl">M'ship Date</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->membershipdate ? \Carbon\Carbon::parse($member->membershipdate)->format('d-M-Y') : '' }}</td>
            </tr>
            <tr>
              <td class="fontSizelbl">Date of Birth</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->dob ? \Carbon\Carbon::parse($member->dob)->format('d-M-Y') : ''}}</td>
              <td></td>
              <td class="fontSizelbl">Card Issue Date</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->cardissuedate ? \Carbon\Carbon::parse($member->cardissuedate)->format('d-M-Y') : '' }}</td>
            </tr>
            <tr>
              <td class="fontSizelbl" rowspan="2">Mailing Address</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal" rowspan="2">{{ $member->mailingaddress }}</td>
              <td></td>
              <td class="fontSizelbl">Card Expiry Date</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal">{{ $member->cardexpirydate ? \Carbon\Carbon::parse($member->cardexpirydate)->format('d-M-Y') : '' }}</td>
            </tr>
            <tr>
              <td></td>
              <td class="fontSizelbl">DHA Discount</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal"></td>
            </tr>
            <tr>
              <td class="fontSizelbl" rowspan="2">Working Address</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal" rowspan="2">{{ $member->workingaddress }}</td>
              <td class="fontSizelbl pl-5">Remarks</td>
              <td class="border-top border-right border-bottom border-left fontSizeVal" colspan="2">{{ $member->remarks }}</td>
            </tr>
          </tbody>
        </table>
      </div>
