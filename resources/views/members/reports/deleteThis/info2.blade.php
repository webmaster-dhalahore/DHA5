...
<div class="row">
  ...
  <div class="col-sm-8" align="right">
    ...
    @if($member)
    <a href="{{ route('member.edit', ['memberid' => $member->memberid]) }}" class="btn btn-sm btn-outline-info"><i class="fas fa-edit mr-2"></i> Edit</a>
    <a href="{{ route('member.reports.member-profile') }}?memberid={{$member->memberid}}" class="btn btn-sm btn-primary"><i class="fas fa-address-card mr-2"></i> Profile</a>
    @endif
...
@push('custom-scripts')
<script>
  const route = "{{ route('member.reports.member-infoold') }}";
</script>
